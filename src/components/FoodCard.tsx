...
const FoodCard: React.FC<FoodCardProps> = ({ img, title, desc }) => {
  return (
    <div className="w-[17rem] min-h-[400px] pt-32 pb-20">
      ...
      <div className="hover:bg-white duration-300 text-center border-2 border-white rounded-tl-[40px] rounded-tr-[10px] rounded-bl-[10px] rounded-br-[40px] pt-20 pb-10">
